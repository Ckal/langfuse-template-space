# langfuse-template-space

Migrated from Hugging Face Spaces.

## Original Space

- URL: https://huggingface.co/spaces/Chris4K/langfuse-template-space
- SDK: docker
...
1. **Private Monorepo** (development)
   - Location: `apps/huggingface/langfuse-template-space/`
   - All development happens here
   - Contains secrets and private configuration

2. **Public GitHub Repository**
   - URL: https://github.com/Ckal/langfuse-template-space
